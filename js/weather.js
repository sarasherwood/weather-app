$(document).ready(function() {
  $.simpleWeather({
    ...
    success: function(weather) {
      html = '<div class="row">' + '<div class="col">' + '<ul><li class="location-style">' + '<strong>Weather Report:</strong>' + ' ' + weather.city + ', ' + weather.region +'</li>' + '</div>' + '</div>'; //outputs the city name + state
...
var timestamp = moment(weather.updated);
      html += '<div class="row">' + '<div class="col">' + '<ul><li class="weather-updated">' + 'Updated' + ' ' + moment(timestamp).fromNow() + '</li>'+'</div>' + '</div>';
